...
def pre_cleanup(buffer):
    '''Pre-cleanup of buffer'''
    mbuffer = re.sub("i\.e\.", "    ", buffer)
    mbuffer = re.sub("e\.g\.", "    ", mbuffer)
    return mbuffer

def get_base_test(buffer, stopwords=True):
    '''Get base test buffer'''
    # substitute latin abbreviations
